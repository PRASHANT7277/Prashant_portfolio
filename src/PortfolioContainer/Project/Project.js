      ...
      <div className="projectDetails">
        <div className="projectCard">
          ...
          <div className="project-card">
            <img id="spe" src={take} alt="" />
            <div className="card-body">
              <div class="badge">BACKEND & FRONTEND</div>
              <div className="projectName">Zara Clone[Group Project]</div>
              ...
              <div className="contentProject">
                ...
                specialises in fast fashion, and sells clothing, accessories,
                shoes, beauty products and perfumes.
              </div>
